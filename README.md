...
Submodule will add the scripts to the repository. But they are weird. But in many cases you or other contributors 
will find files of the submodule are missing. 
