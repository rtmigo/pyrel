...
Submodule will add the scripts to the repository. But in many cases you or other contributors 
will find files of the submodule are missing and additional steps are needed. Submodules are weird.
